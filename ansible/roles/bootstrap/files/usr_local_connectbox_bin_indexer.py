...
<header>
    ...
    if ('recursed' in opts):
        index_file.write("""
                         <tbody>
                         <tr class="clickable"  style="color:#99ceff;">
                             <td></td>
                             <td><a href=".."><svg width="1em" height="1em" version="1.1"
                             use xlink:href="#go-up"></usr></svg>
    ...
    for entry in sorted_entries:
        ...
        # don't include indexs.html in the file listing
        #if entry.name.lower() == DEFAULT_OUTPUT_FILE:
        #    continue
        ...
        try:
            ...
            if 'verbose' in opts: print('ERROR accessing file name:', e, entry)
            continue
        ...
        <tr class="file">
            ...
            <td style="color:#99ceff;" data-order="{size_bytes}">{size_pretty}</td>
            <td style="color:#99ceff;" class="hideable"><time datetime="{last_modified_iso}">{last_modified_human_readable}</time></td>
            <td style="color:#99ceff;" class="hideable"></td>
        </tr>
""")
