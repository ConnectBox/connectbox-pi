...
<<<<<<< HEAD
This document describes the process for creating a waypoint image, suitable for burning by end-users onto microSD. This process can generate images for a NanoPi NEO (NEO), and for a Raspberry Pi (RPi) (tested on Rpi3+ and RPi0w).
=======
...
<<<<<<< HEAD
6. Use the build environment to install the waypoint code onto the uSD card in the target machine.
=======
...
>~$ *cd \<YHD\>*  
<<<<<<< HEAD
>~$ *git clone https://github.com/kirkdwilson/MV-WayPoint/connectbox-tools*   
=======
...
>~$ *vagrant ssh*  
<<<<<<< HEAD
>~$ *git clone https://github.com/kirkdwilson/MV-WayPoint/connectbox-pi*  
=======
...
**Notes:**  
<<<<<<< HEAD
>1. The space required for the base image and additional waypoint code is less than 8GB so a card of 8GB or greater should be ok in the creation process.  Since the Operating System will be on the uSD Card it is important to use a high speed uSD like an XC I rated card.  
...
**Step N3.1:** Use an internet browser to go to [https://github.com/kirkdwilson/MV-WayPoint/armbian-build ]()(the armbian build repo). Near the top you will see (on the line just above "Clone or download") something like, "6220 commits 9 branches 0 packages 15 release...?.. click on "releases" to see a list of the armbian-build releases available. The most recent is "**base-image-190417**". Click on the base-image-190417 text to go to the page for that image. Then find the image itself about halfway down the page under "Assets". (At the time of this writing, the image is "*Armbian\_5.78\_Nanopineo\_Debian-stretch_next\_4.19.34.img.xz*".) Click on that to download; then save in an appropriate directory of your choice.
=======
...
<<<<<<< HEAD
When prompted, enter the password **1234** and when prompted, enter that password again. Then follow the prompts to create the new password (**waypoint**) by entering it twice. Finally, type Ctrl-c which will close the dialog and exit the NEO.
=======
...
>~# *sudo passwd root*    
<<<<<<< HEAD
(follow prompts to give root the password "waypoint")  
=======
...
<<<<<<< HEAD
This completes the creation of an uSD card containing the waypoint software for your target machine. At this point you can now power down the target machine and remove the uSD card. If you want to create a software image (*.img file) which can be used to create other uSD cards with this same image, proceed to **Section 6: Shrinking The Image**. Otherwise you can just put this uSD chip into your target machine and power up to use you waypoint.
=======
...
>~$ *cd /home/vagrant*    
<<<<<<< HEAD
>~$ *waypoint\_GITHUB\_TOKEN=\<your-GitHub-rep-token\> python3 /vagrant/prepare\_release.py* 
=======
...
<<<<<<< HEAD
**Step 3.15:** Power down the target machine and remove the microSD card. This uSD card now contains a waypoint image suitable for running in your target machine. In the next section of the automated build, the Mac will shrink the image which is on the uSD card and from that, create and store an image file (*.img*) suitable for creating other uSD cards with that same image.
=======
...
<<<<<<< HEAD
[https://github.com/kirkdwilson/MV-WayPoint/connectbox-pi/releases/tag/v20200121]()
=======
...
<<<<<<< HEAD
follow prompts to give root the password `waypoint`,then:
=======
...
<<<<<<< HEAD
**Step R6.3:** When this step completes (10-20 minutes) you will have an image of the uSD which will be available in your **/home/pi/waypoint/Images/** directory.
=======
...
<<<<<<< HEAD
**Edwin Steele is the author of much of the waypoint code and for most of the life of the waypoint was the only builder of images for the project. The following are his original instructions on how to create an image from the waypoint code residing on GitHub.**
=======
...
<<<<<<< HEAD
3. The build process tags several repos (see the waypoint_REPOS in [https://github.com/kirkdwilson/MV-WayPoint/connectbox-tools/blob/master/deployment/prepare\_release.py#L18]() for the up-to-date list). The Github account that created the API access token must have write access to each of these repos. If you don't have access to the repositories, ask a person with the owner role in the Github waypoint organisation ([https://github.com/orgs/ConnectBox/people]())
=======
...
<<<<<<< HEAD
2. Prepare a your target device with a base operating system image.  On a NEO, use the most recent release from the [https://github.om/kirkdwilson/MV-WayPoint/armbian-build]() repository. For an RPi, try the most recent release of Raspbian lite, but know that ymmv because their image changes.
=======
...
<<<<<<< HEAD
	1.	Set root password to *waypoint* per the prompts
=======
